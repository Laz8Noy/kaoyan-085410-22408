# -*- coding: utf-8 -*-
"""终极版 XLSX 生成：基于终极版 HTML（含改考动态+导师区块）生成 10 个 Sheet"""
import io, json, re
import openpyxl
...
OUTS = [
    r"<SOURCE_DIR>\02_院校数据_原有\全国408_085410双非热度版_终极版_20260824.xlsx",
]
...
# 8 2027改考动态（从主表 md 提取，与 HTML 注入同源）
...
print("S:", len(S), "C:", len(C), "O:", len(O), "SRCS:", len(SRCS),
      "改考动态:", len(gk_rows), "导师院校:", len(ds_rows), "Sheet总数:", len(wb.sheetnames))
